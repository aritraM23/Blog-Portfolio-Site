              ...
              <table class="table table-striped table-advance table-hover">
                <tbody>
                  <tr>
                    <th>#</th>
                    <th>Post Title</th>
                    <th>Post Category 1</th>
                    <th>Post Category 2</th>
                    <th>Post Category 3</th>
                    <th>Post Date</th>
                    <th>Action</th>
...
<tr>
                    ...
                    <td><?=getCategory($db,$post['category_id2'])?></td>
                    <td><?=getCategory($db,$post['category_id3'])?></td>
...
<div class="form-group col-sm-6">
                      <div class="col-sm-12">
                        <label>Select Post Category 1</label>

                           <select name="post_category1" class="form-control">
                           <?php
$categories = getAllCategory($db);
foreach($categories as $ct){
  ?>
...
?>
                          ...
                          <div class="col-sm-12">
                        <label>Select Post Category 2</label>

                           <select name="post_category2" class="form-control">
                           <?php
$categories = getAllCategory($db);
foreach($categories as $ct){
  ?>
...
?>
                          ...
                          <div class="col-sm-12">
                        <label>Select Post Category 3</label>

                           <select name="post_category3" class="form-control">
                           <?php
$categories = getAllCategory($db);
foreach($categories as $ct){
  ?>
