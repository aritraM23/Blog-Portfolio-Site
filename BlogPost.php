...
<head>
    ...
    <meta name=twitter:description
        content="<?=$post['summary']?>">
    <meta content="2021-07-20T00:00:00+00:00" property="article:published_time">
    <meta name=twitter:image content="https://eugeneyan.com/assets/og_image/mailbag.jpg">
    ...
    <link href="mainUI.css" rel="preload" as="style" onload="this.rel='stylesheet'" type="text/css">
    ...
    <link href="https://fonts.googleapis.com/css2?family=Merriweather:wght@400;700&family=Raleway&display=swap"
        rel="stylesheet">
    <link href="monokai.css" rel="preload" as="style" onload="this.rel='stylesheet'" type="text/css">
    ...
    <script type="text/javascript" src="https://platform-api.sharethis.com/js/sharethis.js#property=610508f4f506cf0019dc2096&product=inline-share-buttons" async="async"></script>
</head>
...
<body>
    <div class="theme-container grow">
        ...
        $post=mysqli_fetch_assoc($runPQ);
                ?>
                    ...
                    <p class="date">
                        <info datetime="2021-07-20 00:00:00 +0000">
    ...
    if($post['category_id2']!=1){
        ?>
                                <a class='tag' href="#">
                                    <?=getCategory($db,$post['category_id2'])?>
                                </a>
                                <?php
    }
    if($post['category_id3']!=1){
        ?>
                                <a class='tag' href="#">
                                    <?=getCategory($db,$post['category_id3'])?>
                                </a>
                                <?php
    }
    ?>
                    ...
                    <div class="notebody">
                        ...
                        <a href="https://www.linkedin.com/shareArticle?url=<URL>&title=<TITLE>&summary=<SUMMARY>&source=<SOURCE_URL>" class="share-btn linkedin">LinkedIn</a>
                        ...
                        <!-- <span style="font-size: 18px; font-weight: bold">Share on: </span> -->
                        <!-- <div id="share-buttons">
                            <div class="twitter" title="Share this on Twitter"
                                onclick="window.open('https://twitter.com/intent/tweet?text=Great read! Mailbag: How to Bootstrap Labels for Relevant Docs in Search&url=https://eugeneyan.com/writing/mailbag-bootstrap-relevant-docs/&via=eugeneyan', 'pop-up', 'left=20,top=20,width=500,height=500,toolbar=1,resizable=0');">
                            ...
                            <div class="linkedin" title="Share this on Linkedin"
                                onclick="window.open('https://www.linkedin.com/shareArticle?mini=true&url=https://eugeneyan.com/writing/mailbag-bootstrap-relevant-docs/&source=eugeneyan.com', 'pop-up', 'left=20,top=20,width=500,height=500,toolbar=1,resizable=0');">
                                <svg viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
                                    <path
                            ...
                            <div class="facebook fb-share-button" title="Share this on Facebook"
                                onclick="window.open('https://www.facebook.com/dialog/share?app_id=249237293114028&display=popup&href=https://eugeneyan.com/writing/mailbag-bootstrap-relevant-docs/&&redirect_uri=https://eugeneyan.com/writing/mailbag-bootstrap-relevant-docs/', 'pop-up', 'left=20,top=20,width=500,height=500,toolbar=1,resizable=0');">
                                <svg viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
                                    <path
                            ...
                            <div class="mail" title="Share this through Email"
                                onclick="window.open('mailto:?subject=Great read! Mailbag: How to Bootstrap Labels for Relevant Docs in Search&body=https://eugeneyan.com/writing/mailbag-bootstrap-relevant-docs/');">
                                <svg viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
                                    <path
            ...
            Chip Huyen
                            ...
                            <!--li><a href="mailto:chip@huyenchip.com">chip@huyenchip.com</a></li-->
                            <li>
                                <a><span class="icon icon--github"><svg viewBox="0 4.801209 28.3499966 25.7475815"
	...
	C13.870162,16.0802422,14.4798384,16.0802422,14.9370966,15.7754021z" />
                                    ...
                                    <span class="username"><span class="__cf_email__"
                                            data-cfemail="0f6c67667f4f677a766a616c67667f216c6062">rohanvk13@gmail.com</span></span></a>

                            </li>
                            <li>
                                <a href="https://github.com/RohanVKashyap"><span class="icon icon--github"><svg
                                            viewBox="0 0 16" width="16px" height="16px">
                                            <path fill="#828282"
                            ...
                            <li>
                                <a href="https://twitter.com/Rohan10395971"><span class="icon icon--twitter"><svg
                                            viewBox="0 0 16 19" width="16px" height="16px">
                                            <path fill="#828282"
                    ...
                    <div class="col-sm-8 footer-col">
                        <p>
                            I’m Rohan Kashyap,a deep learning researcher.I dwell a lot on research and exploration.I
                            mainly write about deep learning and mathematics. </p>
                ...
                <p class="copyright"><a href="https://digicure.github.io/website/">© Digicure</a> • <a
                        href="#">Feedback</a> • <a href="#">Metrics</a> • <a href="#">RSS</a></p>
            </footer>
        </div>
    </div>
    <!-- Go to www.addthis.com/dashboard to customize your tools -->
    ...
    <script defer src="https://static.cloudflareinsights.com/beacon.min.js"
        data-cf-beacon='{"rayId":"67254ac91f585fbe","version":"2021.7.0","r":1,"token":"4ba4ab6acad14218941be7fa4aaad127","si":10}'></script>
